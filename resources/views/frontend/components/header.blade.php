<section class="top-header desktop" style="background-color:#444">
    <div class="container">
        <div class="content">
            <div class="left">
...
<div class="commonTop" style="position: unset !important;">
    <div id="headers" style="background-color:#444!important;">
        <div class="container header-wrapper">
            <!--Thay đổi-->
            <div class="logo">
                <a href="{{  route('get.home') }}" class="desktop">
                    <img src="{{ isset(Auth::user()->avatar) ? pare_url_file(Auth::user()->avatar) : asset('images/Capture.png') }}" style="height: 35px;" alt="Home">
                </a>
